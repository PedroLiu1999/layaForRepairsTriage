// Assemble the static site into dist/: the page from web/ plus vendored libraries (ONNX Runtime Web,
// Tokenizers.js, Cytoscape.js, cytoscape-dagre) and the license files. The model itself is NOT bundled:
// the page streams it from Hugging Face (VishalMysore/layaForWebTrained), so dist/ stays a few MB.
